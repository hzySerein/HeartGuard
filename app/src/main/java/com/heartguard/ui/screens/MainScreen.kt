...
fun MainScreen(
    ...
    Log.d("MainScreen", "About to create MedicationViewModel")
    val medicationViewModel: MedicationViewModel = hiltViewModel()
    Log.d("MainScreen", "MedicationViewModel created successfully")
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(MainRoutes.FAKE_VIDEO_CALL) {
                val fakeVideoCallViewModel: FakeVideoCallViewModel = hiltViewModel()
                FakeVideoCallScreen(
